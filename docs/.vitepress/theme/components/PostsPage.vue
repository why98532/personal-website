...
const posts = [
  { title: { zh: '2025 年 AI 工具推荐：10 款开发效率神器', en: '2025 AI Tools: 10 Essential Picks for Developers' }, summary: { zh: '精选最实用的 AI 工具，涵盖代码助手、智能文档、自动化测试等多个类别', en: 'A curated list of the most practical AI tools covering coding assistants, smart docs, automated testing, and more.' }, category: { zh: 'AI', en: 'AI' }, date: '2025-01-15', link: withBase('/posts/ai-tools-2025') },
  { title: { zh: 'LLM 应用开发实战：从概念到落地', en: 'Building LLM Applications: From Concept to Production' }, summary: { zh: '使用 LangChain 和 OpenAI API 构建 LLM 应用的实战指南，包含完整代码示例', en: 'A hands-on guide to building LLM-powered applications with LangChain and OpenAI API. Complete with code examples.' }, category: { zh: '工程', en: 'Engineering' }, date: '2025-01-05', link: withBase('/posts/llm-app-dev') },
  { title: { zh: '现代前端开发：Vite + Vue 3 实践', en: 'Modern Frontend with Vite + Vue 3' }, summary: { zh: '使用 Vite 和 Vue 3 搭建现代化前端项目，涵盖路由、状态管理和 Tailwind CSS', en: 'How to set up a modern Vue 3 project with Vite, covering routing, state management, and Tailwind CSS integration.' }, category: { zh: '前端', en: 'Frontend' }, date: '2024-12-10', link: withBase('/posts/vite-vue3') },
